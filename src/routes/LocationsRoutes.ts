...
import { LocationsDA } from "../DA/LocationsDA";
...
router.get("/", async (_req: Request, res: Response) =>
{
    try
    {
        const locations = await LocationsDA.getAll();
        res.json(locations);
    } catch (err)
    {
        console.error(err);
...
router.get("/:id", async (req: Request, res: Response) =>
{
    try
    {
        ...
        const location = await LocationsDA.read(id);
...
router.post("/", async (req: Request, res: Response) =>
{
    try
    {
        ...
        const newId = await LocationsDA.create(location);
...
router.put("/", async (req: Request, res: Response) =>
{
    try
    {
        ...
        await LocationsDA.update(location);
